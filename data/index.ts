...
export const gridItems = [
  {
    id: 1,
    title: "Promovemos a maior integração possivel para sua empresa",
    description: "",
  ...
  {
    id: 2,
    title: "Atendemos em qualquer lugar do mundo",
    description: "",
  ...
  },
  {
    ...
    description: "Constantemente aprimorando nossos serviços",
    className: "lg:col-span-2 md:col-span-3 md:row-span-2",
    imgClassName: "",
  ...
  {
    id: 4,
    title: "Entusiastas da tecnologia com paixão pelo desenvolvimento.",
    description: "",
  ...
  {
    id: 5,
    title: "Construir um ecosistema automatizado para você",
  ...
  {
    id: 6,
    title: "Você quer iniciar um projeto conosco?",
    description: "",
    className: "lg:col-span-2 md:col-span-3 md:row-span-1",
    imgClassName: "",
...
export const projects = [
  {
    id: 1,
    title: "Cloud Computing: Infraestrutura Escalável e Segura",
    des: "Potencialize sua empresa com soluções em nuvem de alto desempenho. Oferecemos infraestrutura escalável, segura e de alta disponibilidade para suas aplicações e dados, garantindo confiabilidade e eficiência para o seu negócio.",
    img: "/p1.svg",
    iconLists: ["/cloud-computing-icon.svg"], // Ícone de Cloud Computing
  },
  {
    id: 2,
  ...
  {
    id: 3,
    title: "Gestão de Dados Inteligente com NocoDB",
  ...
  {
    id: 4,
    title: "Banco de Dados PostgreSQL: Segurança e Performance",
